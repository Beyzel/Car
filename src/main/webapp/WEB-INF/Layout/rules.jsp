...
<div class="container">
    ...
    <div class="container">
        ...
        <div class="list-group">
            ...
            <a href="/rule/driverRights" class="list-group-item">2. Обов'язки і права водіїв механічних транспортних засобів</a>
            <a href="/rule/vehiclesWithSpecialSignal" class="list-group-item">3. Рух транспортних засобів із спеціальними сигналами</a>
            ...
            <a href="/rule/requirementsForAnimalsMushers" class="list-group-item">7. Вимоги до осіб, які керують гужовим транспортом, і погоничів тварин</a>
            ...
            <a href="/rule/locationOnTheRoad" class="list-group-item">11. Розташування транспортних засобів на дорозі</a>
        </div>
    </div>
    <br><br>
